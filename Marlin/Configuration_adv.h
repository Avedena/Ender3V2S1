...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE false // Avedena CR Touch failed if you probe more then 4 points in HS mode
 ...
 */
  ...
  //#define OPTIMIZED_MESH_STORAGE  // Avedena // Store mesh with less precision to save EEPROM space
#endif
