...
#define STRING_CONFIG_H_AUTHOR "Avedena" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3S1-UBL-AM3950-CVL"
...
#define HEATER_0_MAXTEMP 300  // Sprite Extruder Pro (All-Metal)
